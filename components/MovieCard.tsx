    ...
    return (
        <div className="group bg-zinc-900 col-span relative h-[12vw]">
            ...
            >
                ...
                <div
                    className="
                        z-10 bg-zinc-800 p-2 lg:p-4 absolute w-full transition
                ...
                >
                    <div className="flex flex-row items-center gap-3">
                        ...
                        <div
                            ...
                            className="
                            cursor-pointer ml-auto group/item w-6 h-6 lg:w-10
                        ...
                        >
                            <BiChevronDown
                                size={30}
                                className="
                                    text-white group-hover/item:text-neutral-300 w-4
                                "
                            />
                        </div>
                    </div>
